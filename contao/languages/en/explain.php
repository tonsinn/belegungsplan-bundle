...
$GLOBALS['TL_LANG']['XPL'] = array(
	'belegungsplan_color_frei'				=> array(
													...
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Freie-Tage-Belegungsplan.gif" alt="">')
												),
	'belegungsplan_color_belegt' 			=> array(
													...
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Belegte-Tage-Belegungsplan.gif" alt="">')
												),
	'belegungsplan_color_text'				=> array(
													...
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Text-Belegungsplan.gif" alt="">')
												),
	...
	'belegungsplan_textDecorationLine'		=> array(
													...
													array('none', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Line-None.jpg" alt="">'),
													array('underline', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Line-Underline.jpg" alt="">'),
													array('overline', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Line-Overline.jpg" alt="">'),
													array('line-through', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Line-Line-Through.jpg" alt="">'),
													array('underline overline', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Line-Underline-Overline.jpg" alt="">'),
													array('underline overline line-through', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Line-Underline-Overline-Line-Through.jpg" alt="">')
												),
	'belegungsplan_textDecorationStyle'		=> array(
													...
													array('solid', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Style-Solid.jpg" alt="">'),
													array('double', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Style-Double.jpg" alt="">'),
													array('dotted', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Style-Dotted.jpg" alt="">'),
													array('dashed', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Style-Dashed.jpg" alt="">'),
													array('wavy', '<img src="bundles/tonsinnbelegungsplan/Text-Decoration-Style-Wavy.jpg" alt="">')
												),
	'belegungsplan_color_rahmen'			=> array(
													...
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Tabellenrahmen-Belegungsplan.gif" alt="">')
												),
	'belegungsplan_anzeige_kategorie'		=> array(
													array('Variable in the template:', '<code class="language-php">&lt;?= $this-&gt;AnzeigeKategorie ?&gt;</code>'),
													array('Output in the template:', '<code class="language-php">true</code> or <code class="language-php">false</code>'),
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Anzeige-Hauptkategorie-Belegungsplan.gif" alt="">')
												),
	'belegungsplan_color_kategorie'			=> array(
													array('Variable in the template:', '<code class="language-php">&lt;?= $this-&gt;RgbaKategorie ?&gt;</code>'),
													array('Output in the template<span style="color:rgba(255,0,0,1.0);">*</span>:', '<code class="language-php">rgba(204,204,204,1.0)</code><br><br><span style="color:rgba(255,0,0,1.0);">*</span><code class="language-php">&nbsp;204,204,204</code> stands for the color and <code class="language-php">1.0</code> for the transparency of the color.<br>These values can differ from the example shown here depending on the selected color and transparency.'),
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/HG-Kategoriezeile-Belegungsplan.gif" alt="">')
												),
	'belegungsplan_color_kategorietext'		=> array(
													...
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Text-Kategoriezeile-Belegungsplan.gif" alt="">')
												),
	...
	'belegungsplan_anzeige_legende'			=> array(
													...
													array('Output in the template:', '<code class="language-php">true</code> or <code class="language-php">false</code>'),
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Anzeige-Legende-Belegungsplan.gif" alt="">')
												),
	'belegungsplan_color_legende_frei'		=> array(
													...
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Legende-Frei-Belegungsplan.gif" alt="">')
												),
	'belegungsplan_color_legende_belegt'	=> array(
													...
													array('Output in the template<span style="color:rgba(255,0,0,1.0);">*</span>:', '<code class="language-php">rgba(255,255,255,1.0)</code><br><br><span style="color:rgba(255,0,0,1.0);">*</span><code class="language-php">&nbsp;255,255,255</code> stands for the color and <code class="language-php">1.0</code> for the transparency of the color.<br>These values can differ from the example shown here depending on the selected color and transparency.'),
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Legende-Belegt-Belegungsplan.gif" alt="">')
												),
	'belegungsplan_anzeige_wochenende'		=> array(
													array('Variable in the template:', '<code class="language-php">&lt;?= $this-&gt;AnzeigeWochenende ?&gt;</code>'),
													array('Output in the template:', '<code class="language-php">true</code> or <code class="language-php">false</code>'),
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Hintergrund-Wochenende-Belegungsplan.gif" alt="">')
												),
	...
	'belegungsplan_color_wochenendetext'	=> array(
													...
													array('Output in the template<span style="color:rgba(255,0,0,1.0);">*</span>:', '<code class="language-php">rgba(51,51,51,1.0)</code><br><br><span style="color:rgba(255,0,0,1.0);">*</span><code class="language-php">&nbsp;51,51,51</code> stands for the color and <code class="language-php">1.0</code> for the transparency of the color.<br>These values can differ from the example shown here depending on the selected color and transparency.'),
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Textfarbe-Wochenende-Belegungsplan.gif" alt="">')
												),
	'feiertage_hintergrund'					=> array(
													array('Variable in the template:', 'No variable in the template'),
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Feiertag-Hintergrund-Belegungsplan.gif" alt="">')
												),
	'feiertage_textcolor'					=> array(
													array('Variable in the template:', 'No variable in the template'),
													array('You can change that with this setting:', '<img src="bundles/tonsinnbelegungsplan/Feiertag-Textfarbe-Belegungsplan.gif" alt="">')
												),
